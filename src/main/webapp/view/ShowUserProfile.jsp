...
<%@include file="/view/deletePost.jsp"%>
 <%@include file="/view/viewFollowingjsp.jsp"%> 
				...
				<div class="col-md-3">
					<div class="card" style="width: 15rem;">
						<samp>
							...
							<samp>
								<h6><%=posts.get(i).getUser().getUserName()%></h6>
								 <a href="#"onClick="deletePost(<%=posts.get(i).getId()%>)"  class="fa-solid fa-trash"
								 	data-toggle="modal" data-target="#deletepost" class="item">
								 </a>
						...
						<span>Like :- <%=posts.get(i).getPostlike().size()%></span>
						 <a href="getComments?postId=<%=posts.get(i).getId()%>&check=true" class="item">ViewComments :-
						 <%=posts.get(i).getComments().size() %></a> 
